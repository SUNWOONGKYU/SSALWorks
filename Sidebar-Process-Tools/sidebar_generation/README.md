...
```bash
cd "C:/!SSAL_Works_Private/Sidebar-Process-Tools/sidebar_generation"
...
- **소스 데이터**: `Sidebar-Process-Tools/sidebar_generation/sidebar_structure.json`
- **동기화 스크립트**: `Sidebar-Process-Tools/sidebar_generation/update_sidebar_html.js`
