...
╔═══════════════════════════════════════════════════════════════════════════════════════╗
║                                                                                       ║
║   Pre-commit Hook 파일 (.git/hooks/pre-commit)                                        ║
║                                                                                       ║
║   ┌─────────────────────────────────────────────────────────────────────────────────┐ ║
║   │                                                                                 │ ║
║   │   #!/bin/sh                                    ← 쉘 스크립트 선언               │ ║
...
║   │   # ─────────────────────────────────────────────────────────────────────────── │ ║
║   │                                                                                 │ ║
║   │   # 1. 웹 자산 빌드 (Order Sheet, Briefings 등)                                 │ ║
║   │   echo "📦 웹 자산 빌드 중..."                                                  │ ║
...
║   ┌─────────────────────────────────────────────────────────────────────────────────┐ ║
║   │                                                                                 │ ║
║   │   📂 .env 파일 위치: P3_프로토타입_제작/Database/.env                           │ ║
║   │                                                                                 │ ║
║   │   ┌───────────────────────────────────────────────────────────────────────────┐ │ ║
║   │   │                                                                           │ │ ║
║   │   │   loadEnv() 함수 동작:                                                    │ │ ║
...
║   │   │                                                                           │ │ ║
║   │   │   해결:                                                                   │ │ ║
║   │   │   1. P3_프로토타입_제작/Database/ 폴더에 .env 파일 생성                   │ │ ║
...
║   │   │      S0_Project-SAL-Grid_생성/method/json/data/index.json                 │ │ ║
║   │   │      S0_Project-SAL-Grid_생성/method/json/data/grid_records/*.json        │ │ ║
...
║   │     경로: S0_Project-SAL-Grid_생성/method/json/data/index.json                  │ ║
║   │     경로: S0_Project-SAL-Grid_생성/method/json/data/grid_records/*.json         │ ║
║   │                                                                                 │ ║
║   │   ───────────────────────────────────────────────────────────────────────────── │ ║
║   │                                                                                 │ ║
║   │   ☑️ 실행                                                                       │ ║
