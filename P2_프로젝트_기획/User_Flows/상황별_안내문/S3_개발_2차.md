...
| Area | 작업 내용 | 유형 |
|------|----------|------|
| Frontend | 대시보드 UI 고도화 | AI-Only |
| Backend_APIs | 고급 API 개발 | AI-Only |
| Security | 권한 체크 시스템 | AI-Only |
| External | 외부 서비스 연동 | Human-AI |
