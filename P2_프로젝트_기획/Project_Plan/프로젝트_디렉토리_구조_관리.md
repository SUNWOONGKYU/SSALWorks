...
// Inbox/Outbox JSON 시스템 (2025-11-18 추가)
app.get('/inbox', (req, res) => {
  // Inbox 폴더의 JSON 파일 목록 반환
})
...
├── Inbox/          ← 작업 지시 JSON 파일 (사용자 → AI)
│   ├── Archive/    ← 완료된 작업 자동 이동
│   └── *.json
...
| 항목 | work_log (.md) | Inbox/Outbox (.json) |
|------|----------------|---------------------|
