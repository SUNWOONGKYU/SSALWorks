...
| 4 | 서비스 소개 모달 MD → index.html 삽입 | `Process/P2_.../Service_Introduction/서비스_소개.md` | `index.html` |
| 5 | SAL Grid 매뉴얼 MD → HTML 변환 | `Process/S0_.../manual/PROJECT_SAL_GRID_MANUAL.md` | `참고자료/*.html` |
| 6 | 빌더 계정 매뉴얼 MD → HTML 변환 | `Process/P2_.../Service_Introduction/빌더용_사용_매뉴얼.md` | `Production/pages/mypage/manual.html` |
