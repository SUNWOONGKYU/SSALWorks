...
Stage는 프로젝트의 진행 단계를 나타낸다. S1은 개발 준비, S2는 개발 1차, S3는 개발 2차, S4는 개발 3차, S5는 개발 마무리 단계이다. 집을 짓는다면 S1에서 설계도를 그리고, S2에서 기초 공사를 하고, S3에서 골조를 올리고, S4에서 마감을 하고, S5에서 입주하는 것과 같다.
