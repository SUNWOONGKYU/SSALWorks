...
- **예시**: `https://cdn.jsdelivr.net/gh/SUNWOONGKYU/SSALWorks@master/부수적_고유기능/학습용_Books/1_Claude_사용법/...`
- **장점**:
...
- **위치**: `부수적_고유기능/학습용_Books/viewer.html`
- **기능**:
  - 사이드바에 카테고리별 콘텐츠 목록
  - 검색 기능
...
### 3.1 MD 파일 작성
1. 적절한 폴더에 MD 파일 생성
   - 예: `부수적_고유기능/학습용_Books/1_Claude_사용법/Claude&ClaudeCode사용법/21편_새로운내용.md`
2. Markdown 형식으로 내용 작성

### 3.2 viewer.html 업데이트 (Claude Code에게 요청)
**요청 예시:**
```
"부수적_고유기능/학습용_Books/1_Claude_사용법/Claude&ClaudeCode사용법/21편_새로운내용.md 파일 추가했어.
viewer.html에 추가해줘."
```

**Claude Code가 업데이트하는 곳:**
1. `부수적_고유기능/학습용_Books/viewer.html` - CONTENTS 객체에 파일 추가
...
### 파일 위치
- 뷰어: `부수적_고유기능/학습용_Books/viewer.html`
- 콘텐츠: `부수적_고유기능/학습용_Books/{대분류}/{중분류}/{파일명}.md`
