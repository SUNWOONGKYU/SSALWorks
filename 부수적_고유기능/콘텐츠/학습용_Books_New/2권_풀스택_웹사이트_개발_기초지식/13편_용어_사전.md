...
### Framework
애플리케이션 구조를 제공하는 도구입니다. Next.js, React가 대표적입니다.
...
### Resend
이메일 발송 서비스입니다. API로 트랜잭션 이메일을 전송합니다.
...
### Supabase
오픈소스 BaaS입니다. PostgreSQL, Auth, Storage를 제공합니다.
...
### Vercel
Next.js를 만든 회사의 호스팅 서비스입니다. 자동 배포, CDN을 제공합니다.
