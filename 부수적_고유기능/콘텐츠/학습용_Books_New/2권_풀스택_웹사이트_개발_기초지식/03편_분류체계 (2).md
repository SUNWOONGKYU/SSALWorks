...
- 행(영역): Database
- 열(스택): Service
- 답: "Supabase는 Database 영역의 Service(BaaS)"
...
| 기술 스택 | 7개 | Language, Runtime, Pkg Mgr, Tools, Library, Framework, Service |
| 매트릭스 | 49셀 | 영역 × 스택 조합 |
...
**작성일: 2025-12-21 / 작성자: Claude / 프롬프터: 써니**
