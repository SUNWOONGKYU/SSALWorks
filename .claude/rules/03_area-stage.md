...
| # | 코드 | 영문명 | 한글명 | 폴더명 |
|---|------|--------|--------|--------|
| 1 | **S1** | Development Setup | 개발 준비 | `S1_개발_준비/` |
| 2 | **S2** | Core Development | 개발 1차 | `S2_개발-1차/` |
| 3 | **S3** | Advanced Features | 개발 2차 | `S3_개발-2차/` |
| 4 | **S4** | QA & Optimization | 개발 3차 | `S4_개발-3차/` |
| 5 | **S5** | Operations | 운영 | `S5_운영/` |
